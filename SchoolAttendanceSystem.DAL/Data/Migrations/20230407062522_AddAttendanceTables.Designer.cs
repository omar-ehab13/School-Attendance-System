...
namespace SchoolAttendanceSystem.DAL.Migrations
{
    ...
    [Migration("20230407062522_AddAttendanceTables")]
            ...
            modelBuilder.Entity("SchoolAttendanceSystem.DAL.Entities.Domain.StudentAttendanceState", b =>
                {
                    ...
                    b.OwnsMany("SchoolAttendanceSystem.DAL.Entities.Domain.Log", "Logs", b1 =>
                        {
                            ...
                            b1.Property<string>("AttendanceStateId")
                                .IsRequired()
                                .HasColumnType("nvarchar(max)");
                            ...
                            b1.Property<string>("StudentAttendanceStateId")
                                .IsRequired()
                                .HasColumnType("nvarchar(450)");

                            b1.HasKey("Id");

                            b1.HasIndex("StudentAttendanceStateId");

                            b1.ToTable("Log");

                            b1.WithOwner("StudentAttendanceState")
                                .HasForeignKey("StudentAttendanceStateId");

                            b1.Navigation("StudentAttendanceState");
                        });
